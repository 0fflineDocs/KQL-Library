...
export const SocialIcon: React.FC<SocialIconProps> = ({ 
  ...
  return (
    <a 
      ...
      className={`text-slate-400 hover:text-slate-200 p-2 rounded-lg hover:bg-slate-800/50 inline-flex items-center justify-center transition-colors duration-200 ${className}`}
